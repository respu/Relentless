...
-- Dumping data for table relentlessdb.account: ~1 rows (approximately)
...
-- Dumping data for table relentlessdb.account_avatar: ~1 rows (approximately)
...
-- Dumping data for table relentlessdb.account_cards: ~0 rows (approximately)
...
-- Dumping data for table relentlessdb.account_data: ~1 rows (approximately)
...
-- Dumping data for table relentlessdb.account_decks: ~0 rows (approximately)
...
-- Dumping data for table relentlessdb.card_types: ~196 rows (approximately)
...
REPLACE INTO `card_types` (`id`, `kind`, `name`, `description`, `flavor`, `subTypesStr`, `rarity`, `hp`, `ap`, `ac`, `costDecay`, `costOrder`, `costGrowth`, `costEnergy`, `rulesList`, `cardImage`, `animationPreviewImage`, `animationPreviewInfo`, `animationBundle`, `abilities`, `targetArea`, `passiveRules`, `sound`, `soundProjectile`, `available`) VALUES
	...
	(3, 'CREATURE', 'Infected Gravelock', 'When Infected Gravelock attacks a creature, that creature gets poisoned for 3 rounds. Infected Gravelock has Move 0.', '"It\'s seeping out of their god-damn pores."\\n- Lord Ungstram, Royal Strategist.', 'Gravelock', 0, 3, 2, 2, 2, 0, 0, 0, '2|AttackForward|DealPoison', 481, 447, '45.75,19.25,0.25', 100, NULL, 'FORWARD', NULL, 'action_gravelock_infected', NULL, 1),
	...
	(40, 'STRUCTURE', 'Junkyard', 'Rat creatures you control gain +1 Health while Junkyard is in play.', 'Rats aren\'t picky.', 'Wall', 0, 3, 0, -1, 0, 0, 1, 0, '1|RatHealthModifier', 507, 455, '80.55,116.3,0.25', 108, NULL, NULL, NULL, NULL, NULL, 1),
	(41, 'CREATURE', 'Kinfolk Brave', NULL, 'Braves are eager to prove their worth. The Jarls are happy to let them.', 'Human,Kinfolk', 2, 2, 2, 1, 0, 0, 2, 0, '2|AttackForward|Move', 508, 456, '96.9,71.6,0.25', 109, '1|Move|Move|Move unit to adjacent tile|0|0|0|0', 'FORWARD', NULL, NULL, NULL, 1),
	...
	(51, 'STRUCTURE', 'Shrine', 'While Shrine is in play, all other units you control gain +1 Health.', 'With a strong enough faith, you don\'t need gods for miracles.', 'Totem', 2, 2, 0, -1, 0, 3, 0, 0, '1|ShrineIncHp', 517, 460, '45.55,95.8,0.25', 113, NULL, NULL, NULL, NULL, NULL, 1),
	...
	(59, 'CREATURE', 'Lifestealer', 'When Lifestealer attacks and destroys a unit, Lifestealer is fully healed.', 'One day he\'ll pay for these borrowed lives.', 'Human', 1, 5, 4, 2, 5, 0, 0, 0, '3|AttackForward|Move|HealVampire', 716, 840, '41.25,86.3,0.25', 240, '1|Move|Move|Move unit to adjacent tile|0|0|0|0', 'FORWARD', NULL, NULL, NULL, 1),
	(60, 'STRUCTURE', 'Eternal Statue', 'At the beginning of your turn, Eternal Statue heals 1 point of Health.', 'It\'s said some sculptors infuse their work with a life of its own.', 'Wall', 0, 4, 0, -1, 0, 0, 2, 0, '1|HealSelf', 526, 465, '61.65,111,0.25', 118, NULL, NULL, NULL, NULL, NULL, 1),
	...
	(65, 'STRUCTURE', 'Ancestral Totem', 'While Ancestral Totem is in play, creatures you control gain +1 Attack.', 'Kinfolk creations aren\'t always pleasant.', 'Totem', 2, 2, 0, -1, 0, 0, 4, 0, '1|TotemPower', 531, 468, '41,85.75,0.25', 121, NULL, NULL, NULL, NULL, NULL, 1),
	...
	(69, 'STRUCTURE', 'Bitter Root', 'When Bitter Root is attacked in melee, attacking unit becomes poisoned for 3 rounds.', '"Sure, there\'s plenty to eat in the swamps. Shame it\'s all poisoned." \\n - Gundar, Marsh Guide.', 'Wall', 1, 2, 0, -1, 2, 0, 0, 0, '1|BitterPoison', 535, 471, '83.8,25.55,0.25', 124, NULL, NULL, NULL, NULL, NULL, 1),
	...
	(90, 'STRUCTURE', 'Proximity Charge', 'When Proximity Charge is destroyed in melee combat, attacking unit is dealt 4 damage. When Proximity Charge comes into play, one copy is summoned on a random adjacent tile.', 'Tread lightly!', 'Wall', 0, 1, 0, -1, 0, 0, 0, 4, '2|ProximityCharge|SummonCopyOnEnterBoard', 555, 476, '65.8,-63.2,0.25', 0, NULL, NULL, NULL, NULL, NULL, 1),
	...
	(97, 'ENCHANTMENT', 'Vengeance Veil', 'When enchanted unit takes damage, its Countdown decreases by 1.', 'All is blood from behind the crimson veil.', NULL, 0, 0, 0, 0, 0, 1, 0, 0, '1|VengeanceVeil', 721, 0, NULL, 0, NULL, NULL, NULL, NULL, NULL, 1),
	(98, 'STRUCTURE', 'Useless Contraption', NULL, 'Working as intended.', 'Wall', 0, 4, 0, -1, 0, 0, 0, 1, NULL, 563, 478, '58.9,8,0.25', 130, NULL, NULL, NULL, NULL, NULL, 1),
	...
	(102, 'ENCHANTMENT', 'Mire Curse', 'Enchanted unit deals 1 poison damage to adjacent creatures at the beginning of each of its turns.', 'It\'s putrid, but it\'s home.', NULL, 1, 0, 0, 0, 2, 0, 0, 0, '1|MireCurse', 567, 0, NULL, 0, NULL, NULL, NULL, NULL, NULL, 1),
	...
	(108, 'STRUCTURE', 'Law Memorial', 'When Law Memorial comes into play, increase Order by 1.', 'You\'d think a people so fond of writing would remember the words of their ancestors.', 'Memorial', 0, 1, 0, -1, 0, 0, 0, 2, '1|IncOutputOrder', 591, 575, '36.15,40.6,0.25', 133, NULL, NULL, NULL, NULL, NULL, 1),
	(109, 'STRUCTURE', 'Desert Memorial', 'When Desert Memorial comes into play, increase Energy by 1.', 'Breakers against the eroding waves of time.', 'Memorial', 0, 1, 0, -1, 0, 2, 0, 0, '1|IncOutputEnergy', 592, 576, '41.15,6.65,0.25', 134, NULL, NULL, NULL, NULL, NULL, 1),
	(110, 'STRUCTURE', 'Tribal Memorial', 'When Tribal Memorial comes into play, increase Growth by 1.', 'Lest we forget the times of peace.', 'Memorial', 0, 1, 0, -1, 0, 0, 0, 2, '1|IncOutputGrowth', 593, 577, '46.25,-11.45,0.25', 135, NULL, NULL, NULL, NULL, NULL, 1),
	(111, 'STRUCTURE', 'Woodland Memorial', 'When Woodland Memorial comes into play, increase Growth by 1.', 'The Kinfolk have forgotten, but the trees remember.', 'Memorial', 0, 1, 0, -1, 0, 2, 0, 0, '1|IncOutputGrowth', 594, 578, '52.6,6.7,0.25', 136, NULL, NULL, NULL, NULL, NULL, 1),
	(112, 'STRUCTURE', 'Sand Pact Memorial', 'When Sand Pact Memorial comes into play, increase Energy by 1.', 'Like grains of sand in an hourglass, our memories fade over time.', 'Memorial', 0, 1, 0, -1, 0, 0, 2, 0, '1|IncOutputEnergy', 595, 579, '41.15,6.15,0.25', 137, NULL, NULL, NULL, NULL, NULL, 1),
	(113, 'STRUCTURE', 'Stone Pact Memorial', 'When Stone Pact Memorial comes into play, increase Order by 1.', 'We remember the times, but not the promises.', 'Memorial', 0, 1, 0, -1, 0, 0, 2, 0, '1|IncOutputOrder', 596, 580, '41.15,23.15,0.25', 138, NULL, NULL, NULL, NULL, NULL, 1),
	...
	(120, 'STRUCTURE', 'Obelisk', NULL, 'Good for leaning on. And hiding behind...', 'Wall', 0, 5, 0, -1, 0, 2, 0, 0, NULL, 603, 583, '50.05,56.55,0.25', 141, NULL, NULL, NULL, NULL, NULL, 1),
	...
	(128, 'CREATURE', 'Royal Spearman', NULL, 'HOOOOOLLLD!', 'Human,Soldier', 1, 3, 2, 2, 0, 3, 0, 0, '3|AttackForward|Move|Spiky2', 611, 590, '60.85,125.3,0.25', 148, '1|Move|Move|Move unit to adjacent tile|0|0|0|0', 'FORWARD', '1|Spiky 2|When Royal Spearman is attacked in melee, Royal Spearman deals 2 damage to attacking unit.', NULL, NULL, 1),
	...
	(137, 'SPELL', 'Return To Nature', 'Opponent creatures get -1 Health until end of turn. If a creature with this effect is killed, increase Growth by 1.', 'Wither and begin anew.', NULL, 1, 0, 0, 0, 2, 0, 0, 0, '1|ReturnToNature', 764, 0, NULL, 0, NULL, 'UNDEFINED', NULL, NULL, NULL, 1),
	...
	(141, 'ENCHANTMENT', 'Plating', 'Enchanted unit disregards next attack or damage taken. Plating is removed afterwards.', 'Almost works like real armor.', NULL, 0, 0, 0, 0, 0, 0, 0, 1, '1|Plating', 738, 0, NULL, 0, NULL, NULL, NULL, NULL, NULL, 1),
	...
	(159, 'SPELL', 'Unbind', 'Sacrifice target non-Decay structure you control. Increase Decay by 1.', '"Let\'s put that to better use."', NULL, 1, 0, 0, 0, 1, 0, 0, 0, '1|Unbind', 766, 0, NULL, 0, NULL, 'TILE', NULL, NULL, NULL, 1),
	...
	(161, 'CREATURE', 'Viscera Sage', 'When Viscera Sage kills another unit, draw 1 scroll.', 'Reading entrails takes a strong stomach.', 'Human', 1, 2, 2, 2, 2, 0, 0, 0, '3|AttackForward|Move|DrawScrollOnKill', 767, 771, '75.05,82.35,0.25', 245, '1|Move|Move|Move unit to adjacent tile|0|0|0|0', 'FORWARD', NULL, NULL, NULL, 1),
	(162, 'CREATURE', 'Loyal Darkling', 'When Countdown is 0, Loyal Darkling can sacrifice itself. When Loyal Darkling is destroyed, it deals 2 damage to your opponent\'s idol on the same row.', 'To night, she\'ll return.', 'Human', 0, 2, 1, 2, 2, 0, 0, 0, '4|AttackForward|Move|SacrificeSelf|DamageIdolOnDeath', 768, 772, '65.1,177.3,0.25', 216, '2|Move|Move|Move unit to adjacent tile|0|0|0|0|SacrificeSelf|Sacrifice|This unit sacrifices itself.|0|0|0|0', 'FORWARD', NULL, NULL, NULL, 1),
	(163, 'CREATURE', 'Husk', NULL, 'Hollow, haggard, happy to help.', 'Undead', 0, 2, 3, 3, 1, 0, 0, 0, '2|AttackForward|Move', 769, 773, '60.05,60.4,0.25', 246, '1|Move|Move|Move unit to adjacent tile|0|0|0|0', 'FORWARD', NULL, NULL, NULL, 1),
	(164, 'CREATURE', 'Mire Shambler', 'Before attacking, Mire Shambler moves to a random adjacent tile.  ', NULL, 'Masked,Undead', 0, 1, 3, 2, 1, 0, 0, 0, '3|AttackMoveRandomly|AttackForward|Move', 770, 831, '63.8,63.1,0.25', 247, '1|Move|Move|Move unit to adjacent tile|0|0|0|0', 'FORWARD', NULL, NULL, NULL, 1),
	(165, 'CREATURE', 'Mangy Rat', 'When Mangy Rat attacks a creature, that creature gets poisoned for 3 rounds. ', 'Tiny Merchants\\nTrader of Graves\\nDeath\'s Servants\\nFate\'s Knaves', 'Beast,Rat', 0, 1, 1, 2, 1, 0, 0, 0, '3|AttackForward|DealPoison|Move', 775, 842, '67.05,-44.95,0.25', 248, '1|Move|Move|Move unit to adjacent tile|0|0|0|0', 'FORWARD', NULL, NULL, NULL, 1),
	(166, 'CREATURE', 'Ilmire Witch Doctor', 'When a Human creature adjacent to Ilmire Witch Doctor is destroyed, an undead Husk creature is summoned in its place.', '"I can\'t promise you eternal life, but I can keep you standing."', 'Human', 2, 5, 5, 2, 6, 0, 0, 0, '3|AttackForwardRanged|Move|HuskSpawner', 777, 778, '86.75,110.25,0.25', 220, '1|Move|Move|Move unit to adjacent tile|0|0|0|0', 'FORWARD', '1|Ranged attack|This unit does not take damage from attacking Spiky units.', NULL, NULL, 1),
	(168, 'CREATURE', 'Blightbearer', 'Blightbearer takes 1 poison damage before attacking. When Blightbearer is destroyed, all creatures on the same row get poisoned for 3 rounds.', 'In this army, illness is no excuse.', 'Human', 1, 4, 3, 2, 3, 0, 0, 0, '4|AttackForward|Move|DamageOneBeforeAttack|DealPoisonToRowCreaturesOnDeath', 779, 780, '60.65,69,0.25', 249, '1|Move|Move|Move unit to adjacent tile|0|0|0|0', 'FORWARD', NULL, NULL, NULL, 1),
	(169, 'STRUCTURE', 'Puppet Soldier', 'When Puppet Soldier dies, all units on the same row are killed.', 'The soldier is false. The fear is not.', 'Wall', 1, 3, 0, -1, 3, 0, 0, 0, '1|KillRowUnitsOnDeath', 781, 782, '32.3,26.3,0.25', 222, NULL, NULL, NULL, NULL, NULL, 1),
	(170, 'STRUCTURE', 'Pillar of Disease', 'Opponent\'s units on the same row as Pillar of Disease have Attack decreased by 1.', 'The Ilmire provides for its own.', 'Wall', 0, 4, 0, -1, 3, 0, 0, 0, '1|PillarDecAp', 783, 785, '38.8,40.3,0.25', 223, NULL, NULL, NULL, NULL, NULL, 1),
	(171, 'ENCHANTMENT', 'Animovore', 'When a unit adjacent to enchanted unit dies, enchanted unit is dealt 1 damage and you draw 1 scroll.', 'I\'ll take a piece of your mind, if you don\'t mind.', NULL, 0, 0, 0, 0, 2, 0, 0, 0, '1|Animovore', 784, 0, NULL, 0, NULL, NULL, NULL, NULL, NULL, 1),
	...
	(173, 'STRUCTURE', 'Totem of Suffering', 'When a creature you control dies, the opposing idol on that row is dealt 1 damage.', 'Empathy can be a cruel thing.', 'Totem', 2, 3, 0, -1, 4, 0, 0, 0, '1|TotemOfSuffering', 789, 790, '42.05,95.8,0.25', 225, NULL, NULL, NULL, NULL, NULL, 1),
	(174, 'ENCHANTMENT', 'Soul Scrounger', 'When a creature is destroyed, enchanted unit\'s Countdown is decreased by 1.', 'Those who have fallen act through the living.', NULL, 1, 0, 0, 0, 3, 0, 0, 0, '1|DecCountdownOnCreatureDeathEnch', 791, 0, NULL, 0, NULL, NULL, NULL, NULL, NULL, 1),
	(175, 'ENCHANTMENT', 'Grisly Graft', 'Enchant creature you control. When Grisly Graft comes into play, sacrifice adjacent creatures. Enchanted creature gains Attack and Health equal to the number of creatures sacrificed.', 'Great needlework!', NULL, 2, 0, 0, 0, 3, 0, 0, 0, '1|GrislyGraft', 792, 0, NULL, 0, NULL, NULL, NULL, NULL, NULL, 1),
	(176, 'ENCHANTMENT', 'Arthritis', 'Each time enchanted unit deals damage, it also deals 1 damage to itself.', 'You\'re only as old as you feel.', NULL, 0, 0, 0, 0, 1, 0, 0, 0, '1|DamageOneOnDamage', 793, 0, NULL, 0, NULL, NULL, NULL, NULL, NULL, 1),
	(177, 'SPELL', 'Restless Bones', 'All your Undead units gain +2 Attack until end of turn, and Countdown decreased by 1.', '"Angering the dead is no trivial task." \\n- Grahm, Animator', NULL, 2, 0, 0, 0, 3, 0, 0, 0, '1|RestlessBones', 794, 0, NULL, 0, NULL, 'UNDEFINED', NULL, NULL, NULL, 1),
	(179, 'ENCHANTMENT', 'Shroud of Unlife', 'When enchanted creature is destroyed, an undead Husk is summoned in its place.', '"You\'ll not find warmth in this garb." \\n- Tobai, Bone Merchant', NULL, 0, 0, 0, 0, 1, 0, 0, 0, '1|HuskSeed', 796, 0, NULL, 0, NULL, NULL, NULL, NULL, NULL, 1),
	(180, 'SPELL', 'Damning Curse', 'Destroy target creature. Units you control are dealt 1 damage.', 'When someone else is paying, who cares about the price?', NULL, 2, 0, 0, 0, 4, 0, 0, 0, '1|DamningCurse', 797, 0, NULL, 0, NULL, 'TILE', NULL, NULL, NULL, 1),
	(181, 'ENCHANTMENT', 'Languid', 'Enchanted unit\'s Attack is decreased by 2. When Languid comes into play, draw 1 scroll.', 'Play nice!', NULL, 0, 0, 0, 0, 2, 0, 0, 0, '1|Languid', 798, 0, NULL, 0, NULL, NULL, NULL, NULL, NULL, 1),
	(182, 'ENCHANTMENT', 'Energy Siphon', 'When Energy Siphon comes into play, increase Energy by 1. Enchanted creature\'s Attack and Health are decreased by 1. ', 'Resources are everywhere. It\'s just a matter of extraction.', NULL, 1, 0, 0, 0, 2, 0, 0, 0, '1|EnergySiphon', 825, 0, NULL, 0, NULL, NULL, NULL, NULL, NULL, 1),
	(183, 'ENCHANTMENT', 'Brain Lice', 'When Brain Lice comes into play, enchanted creature becomes poisoned for 3 rounds. When enchanted creature is destroyed, draw 1 scroll.', 'Scratch all you want. The itch is in your head.', NULL, 1, 0, 0, 0, 3, 0, 0, 0, '1|BrainLice', 800, 0, NULL, 0, NULL, NULL, NULL, NULL, NULL, 1),
	(184, 'ENCHANTMENT', 'Searing Shackles', 'At the end of owner\'s turn, enchanted unit deals 1 damage to the idol on the same row. Enchanted unit is dealt 2 damage when it moves.', 'Death is the only escape.', NULL, 1, 0, 0, 0, 2, 0, 0, 0, '1|SearingShackles', 801, 0, NULL, 0, NULL, NULL, NULL, NULL, NULL, 1),
	(185, 'STRUCTURE', 'Miasma Well', 'All Poison damage is increased by 1.', 'DO NOT DRINK.', 'Totem', 0, 3, 0, -1, 2, 0, 0, 0, '1|IncPoisonDamage', 847, 805, '51.8,63.55,0.25', 226, NULL, NULL, NULL, NULL, NULL, 1),
	(186, 'STRUCTURE', 'Pillar of Fatigue', 'Whenever a creature moves, its Countdown is raised by 1.', 'What good are tactics when your men can\'t lift their swords?', 'Totem', 2, 3, 0, -1, 3, 0, 0, 0, '1|IncCountdownOnMoves', 806, 808, '44.3,43.6,0.25', 227, NULL, NULL, NULL, NULL, NULL, 1),
	(187, 'ENCHANTMENT', 'Infectious Blight', 'Enchanted creature is dealt 1 poison damage at the beginning of each round. If enchanted unit is killed by poison damage, a random creature on the same side gets Infectious Blight.', 'The plague doesn\'t discriminate.', NULL, 2, 0, 0, 0, 4, 0, 0, 0, '1|InfectiousBlight', 807, 0, NULL, 0, NULL, NULL, NULL, NULL, NULL, 1),
	(188, 'SPELL', 'Necrogeddon', 'Destroy all creatures you control. Creatures destroyed this way are replaced by undead Husks at Countdown 0.', '"This won\'t do. Lets start over."\\n-Nuru, Flesh-seamstress.', NULL, 2, 0, 0, 0, 6, 0, 0, 0, '1|Necrogeddon', 827, 0, NULL, 0, NULL, 'UNDEFINED', NULL, NULL, NULL, 1),
	...
	(190, 'SPELL', 'Soul Steal', 'Destroy target creature with health 2 or less. Summon a Mire Shambler on a random tile on your side.', 'Ilmire mercy is worse than death.', NULL, 2, 0, 0, 0, 3, 0, 0, 0, '1|SoulSteal', 812, 0, NULL, 0, NULL, 'TILE', NULL, NULL, NULL, 1),
	(191, 'ENCHANTMENT', 'Regeniture', 'Target unit gains 2 Health. When Regeniture comes into play, enchanted unit\'s controller\'s idol on that row is dealt 1 damage.', 'Sometimes you can squeeze blood from a stone.', NULL, 0, 0, 0, 0, 1, 0, 0, 0, '1|Regeniture', 832, 0, NULL, 0, NULL, NULL, NULL, NULL, NULL, 1),
	(192, 'SPELL', 'Draining Mist', 'All opponent units with Countdown 1 or less have their Countdown increased by 2.', '"Wait, I have an idea!"\\n-Nuru, Flesh-seamstress.', NULL, 0, 0, 0, 0, 3, 0, 0, 0, '1|DrainingMist', 814, 0, NULL, 0, NULL, 'UNDEFINED', NULL, NULL, NULL, 1),
	...
	(194, 'CREATURE', 'Oblivion Seeker', 'When Oblivion Seeker is destroyed, draw 2 scrolls.', 'He leaves nothing but memories. ', 'Human', 1, 3, 2, 2, 5, 0, 0, 0, '3|AttackForwardRanged|Move|DrawScrolls2OnDeath', 816, 819, '65.3,55.8,0.25', 234, '1|Move|Move|Move unit to adjacent tile|0|0|0|0', 'FORWARD', '1|Ranged attack|This unit does not take damage from attacking Spiky units.', NULL, NULL, 1),
	(195, 'CREATURE', 'Ilmire Rot Eater', 'Whenever a creature adjacent Ilmire Rot Eater dies, Ilmire Rot Eater gains 1 Attack and 1 Health.', 'Corpses are surprisingly nutritious.', 'Beast', 0, 3, 3, 2, 3, 0, 0, 0, '3|AttackForward|Move|IncApHpOnAdjacentCreatureDeath', 838, 822, '119.9,37.3,0.25', 251, '1|Move|Move|Move unit to adjacent tile|0|0|0|0', 'FORWARD', NULL, NULL, NULL, 1),
	(196, 'CREATURE', 'Ilmire Hunter', NULL, 'Like the mire, Hunters kill without mercy.', 'Human', 2, 5, 2, 2, 4, 0, 0, 0, '3|AttackForward|Move|Slayer', 817, 820, '90.55,104.95,0.25', 230, '1|Move|Move|Move unit to adjacent tile|0|0|0|0', 'FORWARD', '1|Slayer|When Ilmire Hunter deals damage to a creature, that creature is destroyed.', NULL, NULL, 1),
	(197, 'STRUCTURE', 'Scavenger Construct', 'When an adjacent unit dies, Scavenger Construct\'s Health is increased by 2.', '"Feed the Construct!"\\n- Nuru, Flesh-seamstress.', NULL, 0, 3, 0, -1, 1, 0, 0, 0, '1|IncHp2OnAdjacentDeath', 844, 845, '89.3,41.05,0.25', 254, NULL, NULL, NULL, NULL, NULL, 1),
	(198, 'SPELL', 'Atrophy', 'Target unit\'s Attack is decreased by 5 until end of opponent\'s next turn. ', 'It usually takes longer.', NULL, 0, 0, 0, 0, 1, 0, 0, 0, '1|Atrophy', 830, 0, NULL, 0, NULL, 'TILE', NULL, NULL, NULL, 1),
	(199, 'SPELL', 'Cluster Hex', 'All units on target tile and adjacent tiles gain Curse 1.', 'Curse upon you, and your children, and their children for seven generations.', NULL, 1, 0, 0, 0, 3, 0, 0, 0, '1|ClusterHex', 833, 0, NULL, 0, NULL, 'RADIUS_7', NULL, NULL, NULL, 1),
	(200, 'CREATURE', 'Cursemonger', 'When Countdown is 0, Cursemonger may increase its Countdown by 2 to give target unit Curse 2.', '"Needles and bones, my darling, that\'s my trade."', 'Human', 1, 4, 3, 2, 4, 0, 0, 0, '3|AttackForwardRanged|Move|CursemongerAbility', 916, 835, '70.6,27.8,0.25', 252, '2|Move|Move|Move unit to adjacent tile|0|0|0|0|CursemongerAbility|Curse|When unit\'s Countdown is 0, you may increase the Countdown by 2 to give target unit Curse 2.|0|0|0|0', 'FORWARD', '1|Ranged attack|This unit does not take damage from attacking Spiky units.', NULL, NULL, 1),
	(201, 'ENCHANTMENT', 'Pestis', 'Enchanted creature gains +1 Attack for each Rat you control. When enchanted creature kills another unit, summon a Mangy Rat on a random tile on your side.', 'There\'s no virtue among vermin.', NULL, 1, 0, 0, 0, 3, 0, 0, 0, '1|Pestis', 836, 0, NULL, 0, NULL, NULL, NULL, NULL, NULL, 1),
	(202, 'ENCHANTMENT', 'Hex Marks', 'When enchanted creature damages an idol, it deals 3 extra damage.', 'It\'s not just about looks.', NULL, 0, 0, 0, 0, 1, 0, 0, 0, '1|HexMarks', 837, 0, NULL, 0, NULL, NULL, NULL, NULL, NULL, 1),
	...
	(210, 'STRUCTURE', 'Metal Wonder', 'When your opponent plays a Spell or Enchantment, Metal Wonder deals 2 damage to a random idol under their control.', 'Machine victory, no fiddly bits.', 'Totem', 2, 4, 0, -1, 0, 0, 0, 4, '1|MetalWonder', 870, 872, '59.85,60.55,0.25', 295, NULL, NULL, NULL, NULL, NULL, 1),
	...
	(239, 'ENCHANTMENT', 'Wicked Being', 'When enchanted unit is attacked in melee, attacker gets Curse 1.', 'There are no innocents in the Mire.', NULL, 0, 0, 0, 0, 1, 0, 0, 0, '1|CurseAttacker', 920, 0, NULL, 0, NULL, NULL, NULL, NULL, NULL, 1);
...
-- Dumping data for table relentlessdb.deck_types: ~200 rows (approximately)
...
-- Dumping data for table relentlessdb.server_stats: ~1 rows (approximately)
...
-- Dumping data for table relentlessdb.store_items: ~6 rows (approximately)
...
REPLACE INTO `store_items` (`itemId`, `itemType`, `itemName`, `description`, `costGold`, `costShards`, `isPublic`) VALUES
	...
	(182, 'CARD_ORDER', 'Order Scroll', 'One scroll picked randomly from the Order faction. Good luck!', 200, -1, 1),
	(183, 'CARD_GROWTH', 'Growth Scroll', 'One scroll picked randomly from the Growth faction. Good luck!', 200, -1, 1),
	(184, 'CARD_ENERGY', 'Energy Scroll', 'One scroll picked randomly from the Energy faction. Good luck!', 200, -1, 1),
	(1708255, 'CARD_DECAY', 'Decay Scroll', 'One scroll picked randomly from the Decay faction. Good luck!', 200, -1, 1);
